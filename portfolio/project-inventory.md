...
| 09 | Cruce 2PM | Operational/project coordination route. | Verify. |
| 10 | Mexas in the world | Mexican diaspora and global talent network route. | Ecosystem evidence. |
| 11 | Guatemala AI Panamericana | AI summit, regional network, Costa Rica/LatAm propagation. | Public ecosystem route. |
...
### 1. Local Digital Twins and Civic Infrastructure

Core items:

- Polisplexity LDT4SSC;
- Twin Base Studio;
- Polisplexity Core Platform;
- Tallinn Old Town Freight Evidence;
- Kharkiv route;
- Gaziantep route;
- Iasi / Romanian route;
- Zhytomyr / Ukraine route;
- Aguascalientes government simplification;
...
> diligence, and multi-city proposal strategy across Europe and Mexico.

### 2. Scientific Intelligence and Research Infrastructure

Core items:

- Hadox App Platform;
- Hadox Public Web;
- Eva Research Archive;
- urban-sami;
- Quantum Technologies National Strategy;
- CIMAT/HPC route;
- OEPPEH BI Stack;
...
> workflows for research, public policy, and strategic decision-making.

### 3. Public-Sector AI, Policy, and Institutional Intelligence

Core items:

- SECTEI CDMX;
- Aguascalientes simplification pilot;
- SRE Tecnologias Emergentes;
- GIZ tender route;
- IDB civic AI;
- CAF routes;
...
> policy, development finance, and public-interest digital infrastructure.

### 4. Enterprise Systems, SAP, Deloitte, and Commercial Data Work

Core items:

- SAP/Deloitte enterprise delivery portfolio;
- Diplomado ERP e Inteligencia Artificial SAP;
- BE Discovery Platform;
- BE Selection;
...
> regulated, high-volume, and commercially sensitive organizations.

### 5. Innovation Programs, Startup Applications, and International Expansion

Core items:

- CES Las Vegas / Eureka Park / Innovation Awards / speaking routes;
- K-Startup Grand Challenge;
- 500 Global / 500 LatAm;
- Google startup route;
- Nvidia route;
- Watson Institute;
- Internet Society;
- ESA BIC UK;
...
> fellowships, and global market expansion across North America, Europe, Asia,
> and Latin America.

### 6. Event, Education, Network, and Convening Work

Core items:

- Innovafest;
- Guatemala AI Week / AI Panamericana;
- Red Global MX talent and diaspora surfaces;
- Techstars Startup Weekend AI4ALL CDMX;
- LabLab.ai hackathon leadership;
- talks pages and public technical communication;
- Maker center;
- MOOC GIZ;
...
> communication for international and regional ecosystems.

### 7. Internal Platforms, Automation, and Operating Infrastructure
...
- Hidalgo Digital and other public digital transformation routes;
- IIMAS, MICAI, UTVAM, IPN, UNAM, Tec, Cornell, SFI, MIT ecosystem routes;
- SEG / education and public-sector data work;
- SECTEI, PILARES, PROCINE and CDMX public-sector routes;
- COCYTIEG, InnovacionEsGTO, Guanajuato innovation ecosystem;
- Big Data / retail / SAP / enterprise systems;
- MIT Bootcamp and MIT REAP;
- Red Global MX and diaspora network projects;
- AI, quantum, biotechnology, and scientific strategy routes;
- 2025-2026 proposals around IDB, CAF, GIZ, FTMX, LDT, CES, Korea, Japan,
...
3. **Institutional footprint**: separate from clients.
4. **Evidence appendix**: links to public repositories, sites, papers,
   proposals, decks, and anonymized case studies.
